...
BuildRequires: python3-devel make perl-generators perl-interpreter openssl-devel bison flex findutils git perl-devel openssl gcc llvm lld clang libelf-devel
