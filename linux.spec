...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.13.6.tar.xz
Source1:        config
Source2:        cmdline
...
BuildRequires: python3-devel kmod kernel-devel make perl-generators perl-interpreter openssl-devel bison bc flex findutils git perl-devel openssl gcc llvm lld clang elfutils-libelf-devel
