...
BuildRequires: python3-devel make perl-generators perl-interpreter openssl-devel bison bc flex findutils git perl-devel openssl gcc llvm lld clang elfutils-libelf-devel
